...
- `src/server/finance/`: use-cases e validações do financeiro
- `src/server/accounting/`: use-cases do contábil
- `src/server/mapping/`: regras de mapeamento e pendências
- `src/server/audit/`: audit logs
